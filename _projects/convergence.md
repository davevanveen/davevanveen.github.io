...
description: what happens when ai shapes human thought at scale?
img: assets/img/2604_convergence/convergence_abstract.png
importance: 1
category: stories
...
<div class="row justify-content-sm-center">
    ...
    {% include figure.liquid path="assets/img/2604_convergence/advice.png" title="advice" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
Judgment, once distributed, is now increasingly centralized.
</div>
<br>
...
There are early signs that this shift compresses variation. When writers use generative AI, their collective work becomes less diverse ([source](https://www.science.org/doi/10.1126/sciadv.adn5290)). When models train on their own outputs, minority patterns recede ([source](https://www.nature.com/articles/s41586-024-07566-y)).
...
<div class="row justify-content-sm-center">
    ...
    {% include figure.liquid path="assets/img/2604_convergence/mode_collapse.png" title="mode_collapse" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
As variation narrows, so does diversity of intuition.
</div>
<br>
...
<div class="row justify-content-sm-center">
    ...
    {% include figure.liquid path="assets/img/2604_convergence/convergence_abstract.png" title="convergence_abstract" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
Will AI compress human thought or <a href="#counterpoint">expand it</a>?
</div>
<br>

So what can we do about it?

I don't yet have a solution—nor even a full understanding of the problem. Indeed, I could argue this isn't a problem at all (see [counterpoint](#counterpoint)). But a few directions are worth exploring.
...
<div class="row justify-content-sm-center">
    ...
    {% include figure.liquid path="assets/img/2604_convergence/paths.png" title="paths" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
</div>
